...
def do_plot(x, y, offset, horizontal=False):
    if horizontal:
        return plt.barh(x, y, left=offset)
    else:
        return plt.bar(x, y, bottom=offset)        
    
def cumplot(df, x, y, category, horizontal=False, percent=False, **kwargs):
